...
const MOCK_FIRMS = [
  {
    ...
    is_verified: true,
    description:
      'Largest global prop firm with 400k max allocation and 80% profit split. Known for highly audited operations.',
    rules: {
      profit_target: '10% / 5%',
      max_drawdown: '10%',
      daily_loss: '5%',
  ...
  },
  {
    ...
    is_verified: true,
    description:
      'Highly trusted proprietary trading program offering instant funding models and standard evaluations.',
    rules: {
      profit_target: '8% / 5%',
      max_drawdown: '10%',
      daily_loss: '5%',
  ...
  },
  {
    ...
    is_verified: true,
    description:
      'Provides biweekly payouts, standard/one-step evaluations, and deep liquidity feeds.',
    rules: {
      profit_target: '10% / 5%',
      max_drawdown: '10%',
      daily_loss: '5%',
