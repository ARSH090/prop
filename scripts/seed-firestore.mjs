  ...
  const firms = [
    {
      ...
      is_featured: true,
      is_verified: true,
      description: 'Largest prop firm with 200k max allocation and 80% profit split. Known for strict rules but transparent operations.',
      rules: {
        profit_target: '10%',
        max_drawdown: '5%',
        daily_loss: '3%',
    ...
    },
    {
      ...
      is_featured: true,
      is_verified: true,
      description: 'UK regulated prop firm with crypto trading access. Known for fair dealing desk and quick payouts.',
      rules: {
        profit_target: '10%',
        max_drawdown: '5%',
        daily_loss: '3%',
