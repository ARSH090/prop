...
export async function POST(request: NextRequest) {
  try {
    ...
    await newFirmRef.set({
      ...
      cta_text: cta_text || '',
      payout_custom: payout_custom || '',
      allocation_custom: allocation_custom || '',
      profit_split_custom: profit_split_custom || '',
      discount_label_custom: discount_label_custom || '',
      coupon_code_custom: coupon_code_custom || '',
